...
pub enum AppEvent {
    ...
    ExplorerGotoSubmit,
    ExplorerGotoCancel,
    ExplorerHostActivateCreate,
    ExplorerContainerActivateCreate,
...
pub enum Command {
    ...
    CreateHostFile(String, bool),
    CreateContainerFile(String, String, bool),
    LoadFilePreview(String, String, bool),
