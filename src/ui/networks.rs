...
pub fn render(frame: &mut Frame, area: Rect, state: &mut NetworksState, columns: &crate::config::NetworkColumns, polling_intervals_ms: u64, tick_count: u64) {
    ...
    if state.loading && state.items.is_empty() {
        ...
        let text = Text::from(vec![
            ...
            Line::from(Span::styled(
                format!("  {} Loading networks...", spinner),
